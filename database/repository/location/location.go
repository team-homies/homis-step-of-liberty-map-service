...
type LocationRepository interface {
	FindEventByPoint(MaxLatLon, MinLatLon common.Point) (res *resource.MapInfoResponse, err error)
	FindLocationListByPoint(MaxLatLon, MinLatLon common.Point) (res []resource.MapInfoResponse, err error)
}
...
// 사건 조회
func (g *gormLocationRepository) FindEventByPoint(MaxLatLon, MinLatLon common.Point) (res *resource.MapInfoResponse, err error) {
...
// 위치 리스트 조회
func (g *gormLocationRepository) FindLocationListByPoint(MaxLatLon, MinLatLon common.Point) (res []resource.MapInfoResponse, err error) {
	// 	select event_id, latitude , longitude
	//   from "map"
	//  where  latitude BETWEEN 최소위도 AND 최대위도 AND longitude  BETWEEN 최소경도 AND 최대경도
